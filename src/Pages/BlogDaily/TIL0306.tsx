...
<h3>React 클라이언트 Ajax 요청</h3>
            ...
            <h4>Side Effect</h4>
            <p>함수 내에서 어떤 구현이 함수 외부에 영향을 끼치는 경우 해당 함수는 Side Effect가 있다고 함.</p>
            Pure Function(순수 함수)란 오직 함수의 입력만이 함수의 결과에 영향을 주는 함수를 의미함
            ...
            <p>외부 API 접속이 느릴 경우를 고려해 로딩 화면(loading indicator)의 구현은 필수</p>
